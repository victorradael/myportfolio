        ...
        <Front rotate={rotate}>
          <Title>{user.name}</Title>
            <DevInfoHeader>
              ...
              <DevInfoContacts>
                  <a href="https://github.com/victorradael"  rel="noopener noreferrer" target="_blank">
                    <FaGithub size="3rem" />
                  </a>
                  <a href="https://www.linkedin.com/in/victorradael/"  rel="noopener noreferrer" target="_blank">
                    <FaLinkedin size="3rem" />
                  </a>
                  <a href="https://www.instagram.com/victorradael/"  rel="noopener noreferrer" target="_blank">
                    <FaInstagram size="3rem" />
                  </a>
                  <a href="https://twitter.com/VictorRadael"  rel="noopener noreferrer" target="_blank">
                    <FaTwitter size="3rem" />
                  </a>
